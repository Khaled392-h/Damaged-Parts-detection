...
DATADIR = r"C:\D\Graduation Project 2\datasets\model2\train"
# Loading Train Data
CATEGORIES = ['notDamaged', 'Damaged']
...
test_DATADIR = r"C:\D\Graduation Project 2\datasets\model2\test"
# Loadin Test Data
CATEGORIES = ['notDamaged', 'damaged']
...
carDetection = model.fit(X_train, Y_train, batch_size=32, epochs=30, validation_data=(X_test,Y_test), callbacks=[tensorboard])
...
p = r"C:\D\Graduation Project 2\datasets\model2\train\notDamaged\05378.jpg"
image = prepare(r"C:\D\test cars\dc30.jpg",IMG_SIZE=224)
# image = prepare(p, IMG_SIZE=224)
prediction = model.predict([image])
f=prediction[0][0]*100
r=prediction[0][1]*100
print('%.2f'%f,'%',' Not Damaged')
print('%.2f'%r,'%',' Damaged')
...
os.mkdir(r"C:\D\Graduation Project 2\models\Damage Models\{}".format(t))
model_json = model.to_json()
with open(r"C:\D\Graduation Project 2\models\Damage Models\{}\model.json".format(t), "w") as json_file :
	json_file.write(model_json)

model.save_weights(r"C:\D\Graduation Project 2\models\Damage Models\{}\model.h5".format(t))
print("Saved model to disk")

model.save(r'C:\D\Graduation Project 2\models\Damage Models\{}\CNN.model'.format(t))
